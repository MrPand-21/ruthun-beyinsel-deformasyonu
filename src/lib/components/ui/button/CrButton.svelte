...
<Button.Root
    class={"rounded-md hover:shadow-md inline-flex w-full h-12 items-center justify-center text-md hover:cursor-pointer transition-colors duration-200 font-semibold active:scale-[0.98] active:transition-all " +
